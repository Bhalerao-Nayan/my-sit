...
class DemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demo" do
    assert_difference("Demo.count") do
      post demos_url, params: { demo: { description: @demo.description, name: @demo.name, text: @demo.text } }
    end
  ...
  test "should update demo" do
    patch demo_url(@demo), params: { demo: { description: @demo.description, name: @demo.name, text: @demo.text } }
